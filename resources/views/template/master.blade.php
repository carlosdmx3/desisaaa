            ...
            <li class="nav-item " >
                <a  class="nav-link" style="font-size:14px;">
                    <span class="d-none d-md-inline">
                        @auth
                        <b class="dorado"><span class="fas fa-user"></span>  
                            <span class="guinda">En sesión:</span></b>
                        <b class="dorado">  
            ...
            <li class="nav-item " >
                ...
                <a  href=""
                    ...
                    style="font-size:12px;">
                        <span class="d-none d-md-inline" style="color:red;"> 
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <span class="tx2 modal-title">¿Deseas cerrar tu sesión?</span>
                            ...
                            <div class="modal-body">
                                <button type="button"
                                    ...
                                    Si, salir &nbsp; <i class="nav-icon fas fa-sign-out-alt"></i>&nbsp;
                                </button>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-secondary btn-sm btn-block" 
                                        data-dismiss="modal">
                                    Cancelar esta acción <i class="fas fa-times"></i>
                                </button>
                            </div>
                        </div>
                    </div>
